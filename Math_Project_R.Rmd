...
github: "https://github.com/shieron/Group-7---Math"
...
*	On the bottom right graph _Using Internet to meet people_ it can be seen that 33% of people that met people through an online dating website got married or entered a long-term relationship.
...
Note: This dataset excludes 371 respondents who answered "Don't Know" or "Refuse" to either the question on the quality of life or the question on the use of social networks. Respondents who do not use internet were also excluded.
...
* Relationships  
  --mar: relationship status (1=Married, 2=Living with a partner, 3=Divorced, 4=Separated, 5=          Widowed, 6=Never been married)  
...
We have divided the quality of life into two categories (good and poor) in order to use logistic regression. 20% respondents felt that their quality of life was poor; therefore our baseline model has an accuracy of 20%. We have again divided our data into training and test sets to test our model.    
...
As a result of these constraints, only a limited amout of research could be done specifically on online dating behaviour and how it affects quality of life. 
