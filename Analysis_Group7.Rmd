...
# happiness of people that met online 
df[df[,"rel1"] == 1 , "q1"] 
mean((df[df[,"rel1"] == 1 , "q1"]),na.rm = TRUE)
# happiness of people that met offline 
df[df[,"rel1"] == 2 , "q1"] 
mean((df[df[,"rel1"] == 2 , "q1"]),na.rm = TRUE)
...
df.edu <- cbind(use.internet,use.smartphone)
...
ggplot(df.income.edu) + geom_point(aex(x=edu,y=income))
```
