...
## **Household Economics & Quality of Life**
...
Based on the graph below and the chi square test (low p value), it is evident that respondents with different education level have different income levels.  
...
chisq.test(kcdf.income[ ,'edu'],kcdf.income[,'income'])
```
